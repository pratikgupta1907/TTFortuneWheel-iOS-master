...
public class CarnivalWheelSlice: FortuneWheelSliceProtocol {
    ...
    public var backgroundColor: UIColor? {
        switch style {
        case .brickRed: return TTUtils.uiColor(from:0x0A377C)
        case .sandYellow: return TTUtils.uiColor(from:0x1869BB)
        case .babyBlue: return TTUtils.uiColor(from:0x0A377C)
        case .deepBlue: return TTUtils.uiColor(from:0x1869BB)
        }
    }
